...
angle_offset = 30;
angleA0degArray = [180]; %[((360-angle_offset):-1:0) , (360:-1:(360-angle_offset))]; % 360:-1:0; %0:1:360;
...
title('Position Analysis  (Scale: 1mm = 1mm;  omega = 1 rad/s CW)');
...
subplot(122);
title('Velocity Analysis  (Scale: 1mm = 1mm/s)')
point_a0 = [0,0];
a0a1 = A0A1*omega;
...
fprintf('Velocity of b1 wrt a0 = %.4f mm/s\n',norm(point_a0-point_b1));
fprintf('Velocity of c1 wrt a0 = %.4f mm/s\n',norm(point_a0-point_c1));
